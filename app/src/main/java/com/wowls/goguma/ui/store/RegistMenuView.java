...
import com.wowls.goguma.list.MenuListAdapter;
...
public class RegistMenuView
{
    ...
    public void setMenuList(ArrayList<MenuInfo> list)
    {
        ...
        mMenuList = list;
        mStoreId.setText(mMenuList.get(0).getStoreId());
        ...
        public void onClick(View v)
        {
            switch (v.getId())
            {
                ...
                case R.id.btn_edit:
                    ...
                    mListAdapter = new MenuListAdapter(RegistMenuView.this, mMenuList, mContext, mIsEditMode);
                ...
                case R.id.btn_submit:
                    ...
                    MenuInfo info = new MenuInfo(mStoreId.getText().toString(), menu, price);
                    mMenuList.add(info);
    ...
    {
        mListAdapter = new MenuListAdapter(this, mMenuList, mContext, mIsEditMode);
        mListView.setAdapter(mListAdapter);
    }
    ...
    public void editDialog()
    {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.producer_regist_menu_edit_dialog, null, false);
